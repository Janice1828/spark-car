        ...
        <div className='pt-5'>
            <div className='row text-light pt-5'>
                ...
                <div className="col-3">
                    ...
                    <p className='fs-16 fw-400 d-flex gap-2 align-items-center'><i class="fa-solid fa-location-dot text-green fs-15"></i><span>Trade Tower Thapathali, address2</span></p>
                    <p className='fs-16 fw-400 d-flex gap-2 align-items-center'><i class="fa-solid fa-phone text-green fs-15"></i><span>01-5971616/ 9801101924</span></p>
                    <p className='fs-16 fw-400 d-flex gap-2 align-items-center'><i class="fa-solid fa-envelope text-green fs-15"></i><span>info@sparkcar.org</span></p>
                </div>
                <div className="col-3">
